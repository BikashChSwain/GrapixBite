...
if ($name == "") {
    ...
    $to = 'grapixbite@gmail.com';
    $subject = 'GrapixBite Contact Form Details';
    ...
    $headers .= 'From:  GrapixBite <contact@grapixbite.com>' . "\r\n";
    $headers .= 'cc: grapixbite@gmail.com' . "\r\n";
    $headers .= 'bcc: grapixbite@gmail.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f contact@grapixbite.com');
